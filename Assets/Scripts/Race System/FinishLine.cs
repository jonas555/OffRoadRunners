...
public class FinishLine : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider collider)
    {
        ...
        if(collider.gameObject.tag == "Player")
        {
            ...
            PlayerPrefs.SetInt("MinSkirmishSave", TimeLapManager.MinuteCount);
            PlayerPrefs.SetInt("SecSkirmishSave", TimeLapManager.SecondCount);
            PlayerPrefs.SetFloat("MilliSkirmishSave", TimeLapManager.MilliCount);
